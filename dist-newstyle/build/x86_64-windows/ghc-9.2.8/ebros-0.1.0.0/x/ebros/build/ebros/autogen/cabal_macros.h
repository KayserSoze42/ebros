...
/* package ebros-0.1.0.0 */
#ifndef VERSION_ebros
#define VERSION_ebros "0.1.0.0"
#endif /* VERSION_ebros */
#ifndef MIN_VERSION_ebros
#define MIN_VERSION_ebros(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ebros */
...
#define CURRENT_COMPONENT_ID "ebros-0.1.0.0-inplace-ebros"
